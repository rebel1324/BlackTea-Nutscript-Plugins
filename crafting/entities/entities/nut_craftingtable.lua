...
if (SERVER) then
	...
	function ENT:onDrawEntityInfo(alpha)
		...
		nut.util.drawText("조합대", x, y, ColorAlpha(nut.config.get("color"), alpha), 1, 1, nil, alpha * 0.65)
		nut.util.drawText("E키로 누구나 사용이 가능합니다.", x, y + 16, ColorAlpha(color_white, alpha), 1, 1, "nutSmallFont", alpha * 0.65)
	end
end
